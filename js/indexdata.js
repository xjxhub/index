...
for(var n=0;n<navs.length;n++){
    ...
    for(var se=0,th=0;se<navs[n].second.length,th<navs[n].third.length;se++,th++){
        navjs+=`<li>`;
        navjs+=`<div class="dr-a">` + `<span>` + navs[n].second[se] +`</span>`;
    ...
    // for(var th=0;th<navs[n].third.length;th++){ 
        ...
        for(var key in navs[n].third[th]){
            for(var thi = 0 ;thi < navs[n].third[th][key].length; thi++){
                navjs+=`<li><a href="#">`+navs[n].third[th][key][thi]+`</a></li>`;
            }
            break;
        }
        // break;
...
//console.log(indexdata.navs[0].third[0].third1[0]);
 ...
 // $('#paging').paging({
    ...
    //         var currentPages = now * 6 < videoData.length ? 6 : videoData.length - (now - 1) * 6;
            ...
            for (var i = 0; i < videoData.length / 3 +1; i++) {
                ht += `<div class="row">`;
                if(i*3 < videoData.length){
                    ht += `<div class="col-md-4 col-sm-4 row-a">`;
                    ht += `<a class="${videoData[i*3].numi}" href="${videoData[i*3].href}" target="_blank">`;
                    ht += `<div class="mask-play zz">`;
                    ht += `<img src="${videoData[i*3].images}">`;
                    ht += `<div class="mask">`;
                    ht += `<img class="play" src="imgs/play3.png">`;
                    ht += `<p class="ppv ${videoData[i*3].ppt}">` + "PPT" + `</p>`;
                    ht += `<p class="ppv">` + "Video" + `</p>`;
                    ht += `</div>`;
                    ht += `</div>`;
                    ht += `<div class="${videoData[i*3].num} intro">` + videoData[i*3].introduce + `</div>`;
                    ht += `</a>`;
                    ht += `<p class="p"><a href="${videoData[i*3].titlehref}" target="_blank">` + videoData[i*3].title + `</a></p>`;
                    ht += `</div>`;
                }
                if(i*3+1 < videoData.length){
                    ht += `<div class="col-md-4 col-sm-4 row-a">`;
                    ht += `<a class="${videoData[i*3+1].numi}" href="${videoData[i*3+1].href}" target="_blank">`;
                    ht += `<div class="mask-play zz">`;
                    ht += `<img src="${videoData[i*3+1].images}">`;
                    ht += `<div class="mask">`;
                    ht += `<img class="play" src="imgs/play3.png">`;
                    ht += `<p class="ppv ${videoData[i*3+1].ppt}">` + "PPT" + `</p>`;
                    ht += `<p class="ppv">` + "Video" + `</p>`;
                    ht += `</div>`;
                    ht += `</div>`;
                    ht += `<div class="${videoData[i*3+1].num} intro">` + videoData[i*3+1].introduce + `</div>`;
                    ht += `</a>`;
                    ht += `<p class="p"><a href="${videoData[i*3+1].titlehref}" target="_blank">` + videoData[i*3+1].title + `</a></p>`;
                    ht += `</div>`;
                }
                if(i*3+2 < videoData.length){
                    ht += `<div class="col-md-4 col-sm-4 row-a">`;
                    ht += `<a class="${videoData[i*3+2].numi}" href="${videoData[i*3+2].href}" target="_blank">`;
                    ht += `<div class="mask-play zz">`;
                    ht += `<img src="${videoData[i*3+2].images}">`;
                    ht += `<div class="mask">`;
                    ht += `<img class="play" src="imgs/play3.png">`;
                    ht += `<p class="ppv ${videoData[i*3+2].ppt}">` + "PPT" + `</p>`;
                    ht += `<p class="ppv">` + "Video" + `</p>`;
                    ht += `</div>`;
                    ht += `</div>`;
                    ht += `<div class="${videoData[i*3+2].num} intro">` + videoData[i*3+2].introduce + `</div>`;
                    ht += `</a>`;
                    ht += `<p class="p"><a href="${videoData[i*3+2].titlehref}" target="_blank">` + videoData[i*3+2].title + `</a></p>`;
                    ht += `</div>`;
                }
                ht += `</div>`;
                ...
                //create_dl.html(_html).addClass('bounceIn ');
